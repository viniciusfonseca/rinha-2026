...
#define RINHA_IVF_NLIST 256u
#define RINHA_IVF_NPROBE 4u
#define RINHA_PQ_M 7u
#define RINHA_PQ_SUBDIM 2u
#define RINHA_PQ_KSUB 16u
#define RINHA_IVF_PQ_RERANK 64u
#define RINHA_IVF_PQ_TRAIN_SAMPLES 8192u
#define RINHA_IVF_PQ_KMEANS_ITERS 8u
